      ...
      roots: [
        {
          ...
          reach: -1.18,
          pts: [
            { x: -0.12, y: 0.22, z: 0.04 },
            { x: -0.42, y: 0.10, z: 0.08 },
            { x: -0.78, y: 0.03, z: 0.02 },
            { x: -1.18, y: 0.01, z: -0.12 }
          ]
        },
        {
          name: "root-right",
          ...
          reach: 0.62,
          pts: [
            { x: 0.10, y: 0.18, z: 0.02 },
            { x: 0.32, y: 0.07, z: -0.04 },
            { x: 0.62, y: 0.015, z: -0.08 }
          ]
        },
        {
          name: "root-back",
          ...
          reach: 0.12,
          pts: [
            { x: 0.02, y: 0.16, z: -0.10 },
            { x: 0.08, y: 0.06, z: -0.34 },
            { x: 0.12, y: 0.012, z: -0.58 }
          ]
        }
      ],
      branches: [
        {
          ...
          r: 0.028,
          pts: [
            { x: 0.28, y: 2.05, z: 0.04 },
            { x: 0.62, y: 2.12, z: 0.10 },
            { x: 1.05, y: 2.08, z: 0.06 }
          ]
        },
        {
          ...
          r: 0.022,
          pts: [
            { x: -0.30, y: 3.55, z: 0.02 },
            { x: -0.72, y: 3.82, z: 0.08 },
            { x: -1.08, y: 4.12, z: 0.04 }
          ]
        },
        {
          ...
          r: 0.016,
          pts: [
            { x: -0.22, y: 5.15, z: -0.02 },
            { x: -0.55, y: 5.42, z: 0.06 },
            { x: -0.82, y: 5.72, z: 0.02 }
          ]
        }
      ]
    };
